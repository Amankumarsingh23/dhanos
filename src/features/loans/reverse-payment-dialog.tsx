...
import { reverseLoanPaymentAction } from "./actions";
import type { LoanPaymentRecord } from "./queries";
 ...
 * clearly that the linked cash transaction is untouched, since that's a
 * common point of confusion when correcting a data-entry mistake.
 */
export function ReversePaymentDialog({
  ...
  function handleSubmit(event: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await reverseLoanPaymentAction(householdId, {
